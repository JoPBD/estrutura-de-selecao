-- dada uma data no formato ddmmaaaa veriricar se ela é valida
-- testar 22/10/2022: valida
-- 29/02/2020 valida
-- 29/02/2021 invalida
					...
					IF  mes = 2 THEN 
						CASE
							...
							WHEN (ano % 4 = 0 AND ano % 100 <> 0) THEN
								...
								END IF;
							ELSE
								-- estamos em fevereiro e o ano não é bissexto
								IF dia > 28 THEN
									data_valida := FALSE;
								END IF;
					END IF;
...
-- 	RAISE NOTICE 'O valor gerado fii %', valor;
-- 	IF valor < 20 THEN
